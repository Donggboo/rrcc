...
public:
    ...
    int ReceiveRtt(Ptr<Packet> p, CustomHeader &ch);
	...
	void UpdateRateHpRTT(Ptr<RdmaQueuePair> qp, Ptr<Packet> p, CustomHeader &ch, bool fast_react);
	 ...
	 * my-cc
	 ********************/
    void HandleRTT(Ptr<RdmaQueuePair> qp, Ptr<Packet> p, CustomHeader &ch);
};
